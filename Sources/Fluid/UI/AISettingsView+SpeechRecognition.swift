                        ...
                        HStack {
                            ...
                            if let badge = model.badgeText {
                                Text(badge)
                                    ...
                                    .padding(.vertical, 2)
                                    .background(Capsule().fill(badge == "TriVox Pick" ? .cyan.opacity(0.2) : .orange.opacity(0.2)))
                                    .foregroundStyle(badge == "TriVox Pick" ? .cyan : .orange)
                            }
                    ...
                    VStack(alignment: .trailing, spacing: 4) {
                                  ...
                                  let progress = self.viewModel.asr.downloadProgress
                        {
                            ProgressView(value: progress)
                                ...
                                .frame(width: 90)
                                .help("Downloading the model's main file (\(model.downloadSize)) — the bar may stay still for a while before it moves again.")
